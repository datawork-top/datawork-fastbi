...
package top.datawork.core.common.jdbc;
...
import top.datawork.core.utils.SourceUtils;
...
import static top.datawork.core.consts.Consts.JDBC_DATASOURCE_DEFAULT_VERSION;
    ...
    public DruidDataSource getDataSource(JdbcSourceInfo jdbcSourceInfo) throws SourceException {
        ...
        try {
            ...
            if (StringUtils.isEmpty(dbVersion) ||
            	...
            	String path = System.getenv("FASTBI_HOME") + File.separator  + String.format(Consts.PATH_EXT_FORMATTER, jdbcSourceInfo.getDatabase(), dbVersion);
