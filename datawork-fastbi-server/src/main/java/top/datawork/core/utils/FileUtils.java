...
public class FileUtils {
    ...
    public boolean isImage(MultipartFile file) {
        Matcher matcher = Consts.PATTERN_IMG_FORMAT.matcher(file.getOriginalFilename());
        return matcher.find();
    }

    public boolean isImage(File file) {
        Matcher matcher = Consts.PATTERN_IMG_FORMAT.matcher(file.getName());
        return matcher.find();
    }
    ...
    public String getFilePath(FileTypeEnum type, MsgWrapper msgWrapper) {
        ...
        sb.append(Consts.UNDERLINE).append(System.currentTimeMillis()).append(type.getFormat());
