...
import top.datawork.fastbi.core.model.DataUploadEntity;
import top.datawork.fastbi.core.model.RedisMessageEntity;
import top.datawork.fastbi.core.utils.CsvUtils;
import top.datawork.fastbi.core.utils.ExcelUtils;
import top.datawork.fastbi.core.utils.SourcePasswordEncryptUtils;
...
import top.datawork.fastbi.service.SourceService;
...
public class SourceServiceImpl extends BaseEntityService implements SourceService {
    ...
    public boolean testSource(SourceTest sourceTest) throws ServerException {
        ...
        try {
            ...
            if (StringUtils.isEmpty(sourceTest.getVersion())
                    || Consts.JDBC_DATASOURCE_DEFAULT_VERSION.equals(sourceTest.getVersion())) {
                sourceTest.setVersion(null);
    ...
    private void publishReconnect(String message, Long id) {
        redisUtils.convertAndSend(Constants.DAVINCI_TOPIC_CHANNEL, new RedisMessageEntity(SourceMessageHandler.class, message, String.valueOf(id)));
    }
