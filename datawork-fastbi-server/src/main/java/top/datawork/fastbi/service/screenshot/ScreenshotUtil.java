...
package top.datawork.fastbi.service.screenshot;
...
import static top.datawork.fastbi.service.screenshot.BrowserEnum.valueOf;
...
public class ScreenshotUtil {
    ...
    private WebDriver generateWebDriver(Long jobId, Integer imageWidth) throws ExecutionException {
        WebDriver driver;
        BrowserEnum browserEnum = BrowserEnum.valueOf(DEFAULT_BROWSER);
        switch (browserEnum) {
            case CHROME:
