...
enum Types {
  ...
  LOAD_WIDGET_SHARE_LINK = 'fastbi/Dashboard/LOAD_WIDGET_SHARE_LINK',
  LOAD_WIDGET_SHARE_LINK_SUCCESS = 'fastbi/Dashboard/LOAD_WIDGET_SHARE_LINK_SUCCESS',
  LOAD_WIDGET_SHARE_LINK_FAILURE = 'fastbi/Dashboard/LOAD_WIDGET_SHARE_LINK_FAILURE',
  LOAD_WIDGET_AUTHORIZED_SHARE_LINK_SUCCESS = 'fastbi/Dashboard/LOAD_WIDGET_AUTHORIZED_SHARE_LINK_SUCCESS',
  LOAD_WIDGET_PASSWORD_SHARE_LINK_SUCCESS = 'fastbi/Dashboard/LOAD_WIDGET_PASSWORD_SHARE_LINK_SUCCESS',


  OPEN_SHARE_PANEL = 'fastbi/Dashboard/OPEN_SHARE_PANEL',
  CLOSE_SHARE_PANEL = 'fastbi/Dashboard/CLOSE_SHARE_PANEL',

  LOAD_WIDGET_CSV = 'fastbi/Dashboard/LOAD_WIDGET_CSV',
  LOAD_WIDGET_CSV_SUCCESS = 'fastbi/Dashboard/LOAD_WIDGET_CSV_SUCCESS',
  LOAD_WIDGET_CSV_FAILURE = 'fastbi/Dashboard/LOAD_WIDGET_CSV_FAILURE',

  RENDER_DASHBOARDITEM = 'fastbi/Dashboard/RENDER_DASHBOARDITEM',
  RESIZE_DASHBOARDITEM = 'fastbi/Dashboard/RESIZE_DASHBOARDITEM',
  RESIZE_ALL_DASHBOARDITEM = 'fastbi/Dashboard/RESIZE_ALL_DASHBOARDITEM',
  RENDER_CHART_ERROR = 'fastbi/Dashboard/RENDER_CHART_ERROR',
  DRILL_DASHBOARDITEM = 'fastbi/Dashboard/DRILL_DASHBOARDITEM',
  DELETE_DRILL_HISTORY = 'fastbi/Dashboard/DELETE_DRILL_HISTORY',
  DRILL_PATH_SETTING = 'fastbi/Dashboard/DRILL_PATH_SETTING',
  DRILL_PATH_DASHBOARDITEM = 'fastbi/Dashboard/DRILL_PATH_DASHBOARDITEM',
  DELETE_DRILL_PATH_HISTORY = 'fastbi/Dashboard/DELETE_DRILL_PATH_HISTORY',
  SELECT_DASHBOARD_ITEM_CHART = 'fastbi/Dashboard/SELECT_DASHBOARD_ITEM_CHART',
  MONITORED_SYNC_DATA_ACTION = 'fastbi/Dashboard/MONITORED_SYNC_DATA_ACTION',
  MONITORED_SEARCH_DATA_ACTION = 'fastbi/Dashboard/MONITORED_SEARCH_DATA_ACTION',
  MONITORED_LINKAGE_DATA_ACTION = 'fastbi/Dashboard/MONITORED_LINKAGE_DATA_ACTION'
}
